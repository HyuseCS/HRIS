...
-->
	...
	<div class="grid gap-3 sm:grid-cols-3">
		...
		{#if data.showBranches}
			<Field label="Branch" id="branchId" hint="Which store this employee works out of.">
				{#snippet children(a)}
					<select
						{...a}
						id="branchId"
		...
		<Field
			label="Company Email"
			id="companyEmail"
			hint="Seeded with the hire's working email at onboarding — update it once the real company address is provisioned."
			class="sm:col-span-3"
		>
			{#snippet children(a)}
				<input
		...
		<Field
			label="Discord ID"
			id="discordId"
			hint="In Discord: enable Developer Mode → right-click the user → Copy User ID. Leave blank to unlink."
			class="sm:col-span-3"
		>
			{#snippet children(a)}
				<input
		...
		<Field label="Work Schedule" id="workScheduleId">
			{#snippet children(a)}
				<select
					{...a}
					id="workScheduleId"
		...
		<Field
			label="Position"
			id="positionId"
			hint="Sets the pay band used for the salary check above."
		>
			{#snippet children(a)}
				<select
					{...a}
		...
		<Field label="SSS Number" id="sssNumber">
			{#snippet children(a)}
				<input
					{...a}
					id="sssNumber"
		...
		<Field label="PhilHealth No." id="philhealthNumber">
			{#snippet children(a)}
				<input
					{...a}
					id="philhealthNumber"
		...
		<Field label="Pag-IBIG No." id="pagibigNumber">
			{#snippet children(a)}
				<input
					{...a}
					id="pagibigNumber"
		...
		<Field label="Account Name" id="bankAccountName">
			{#snippet children(a)}
				<input
					{...a}
					id="bankAccountName"
		...
		<Field label="Bank Account No." id="bankAccountNumber">
			{#snippet children(a)}
				<input
					{...a}
		...
		<Field label="GCash No." id="gcashNumber">
			{#snippet children(a)}
				<input
					{...a}
					id="gcashNumber"
