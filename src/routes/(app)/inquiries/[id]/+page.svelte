...
<svelte:head>
	<!-- R2: an inquiry is itself the sensitive fact, so the subject stays out of the browser tab,
	     the history list and any shared screen. -->
	<title>Inquiry — Inquiries — Veent HRIS</title>
</svelte:head>
...
<div class="mx-auto max-w-3xl space-y-6">
	...
	>
		{#snippet back()}
			...
			<a href="/inquiries" class="text-sm text-muted-foreground hover:text-foreground"
				>← Back to inquiries</a
			>
		{/snippet}
	</PageHeader>
