...
**Rebased onto staging 17-09-26 (after PR #14 merged):** S2 and the `/timesheets` half of S3 were
...
`src/lib/components/attendance/AttendanceHrGrid.svelte` · `src/lib/components/attendance/shared.ts` ·
